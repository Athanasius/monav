...
class HeaderBlock : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_bbox(::PBF::HeaderBBox* bbox);
...
class PrimitiveBlock : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_stringtable(::PBF::StringTable* stringtable);
...
class PrimitiveGroup : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_dense(::PBF::DenseNodes* dense);
...
class Node : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_info(::PBF::Info* info);
...
class DenseNodes : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_denseinfo(::PBF::DenseInfo* denseinfo);
...
inline void HeaderBlock::set_allocated_bbox(::PBF::HeaderBBox* bbox) {
  delete bbox_;
  bbox_ = bbox;
  if (bbox) {
    set_has_bbox();
...
inline void PrimitiveBlock::set_allocated_stringtable(::PBF::StringTable* stringtable) {
  delete stringtable_;
...
inline void PrimitiveGroup::set_allocated_dense(::PBF::DenseNodes* dense) {
  delete dense_;
  dense_ = dense;
  if (dense) {
    set_has_dense();
...
inline void Node::set_allocated_info(::PBF::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
...
inline void DenseNodes::set_allocated_denseinfo(::PBF::DenseInfo* denseinfo) {
  delete denseinfo_;
...
inline void Way::set_allocated_info(::PBF::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
...
inline void Relation::set_allocated_info(::PBF::Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
...
template <> struct is_proto_enum< ::PBF::Relation_MemberType> : ::google::protobuf::internal::true_type {};
template <>
