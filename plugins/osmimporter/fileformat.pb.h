...
class Blob : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_bzip2_data(::std::string* bzip2_data);
...
inline void Blob::set_allocated_bzip2_data(::std::string* bzip2_data) {
  if (bzip2_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete bzip2_data_;
  }
  if (bzip2_data) {
    set_has_bzip2_data();
    bzip2_data_ = bzip2_data;
  } else {
    clear_has_bzip2_data();
    bzip2_data_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
...
inline void BlockHeader::set_allocated_type(::std::string* type) {
  if (type_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete type_;
  }
  if (type) {
...
inline void BlockHeader::set_allocated_indexdata(::std::string* indexdata) {
  if (indexdata_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete indexdata_;
  }
  if (indexdata) {
